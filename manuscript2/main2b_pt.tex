...
\usepackage{booktabs}
\usepackage{url}
% Posicionamento de floats: figuras e tabelas no topo ou no rodape da pagina,
% nunca no meio de um paragrafo.
...
\begin{table*}[width=\textwidth,cols=7,pos=!ht]
...
\begin{table*}[width=\textwidth,cols=8,pos=!ht]
