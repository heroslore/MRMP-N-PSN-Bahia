...
\author[1]{Fabrício Berton Zanchi}
...
A base mensal (297 meses por bioma, 2001--2025) é fornecida como material suplementar (arquivo CSV). O código em Python e os scripts de extração estão disponíveis em repositório público [inserir DOI do repositório].
