...
| `manuscript2/` | Draft of the companion paper on the ENSO analysis and the sampling unit in phase composites (`main2_pt.tex`, Portuguese), with its bibliography, figures and compiled PDF. |
